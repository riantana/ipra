...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url();?>assets/css/custom/main_custom.css">
    <!-- need custom -->
...
<body>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                class="sidebar-item <?=url_is('home');?> ">
            ...
            <li
                ...
                <ul class="submenu ">
                    <li class="submenu-item  <?=url_is('design');?>">
                        <a href="<?=base_url();?>design/ubah/2">Design DIPA</a>
                    </li>
